...
import com.willc.collector.lib.elements.ITextElement;
import com.willc.collector.lib.elements.LineElement;
import com.willc.collector.lib.elements.PointElement;
import com.willc.collector.lib.elements.TextElement;
...
import com.willc.collector.utils.NumberUtil;
 ...
 * @author keqian 面要素采集
 */
public class PolygonCollector extends GeoCollector {
    private static final String TAG = PolygonCollector.class.getSimpleName();
